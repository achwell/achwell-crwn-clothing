...
import {signInFailure, signOutFailure, signOutSuccess} from './user.actions';
...
describe('on sign in after sign up saga', () => {
    it('should fire getSnapshotFromUserAuth', () => {
        ...
        const mockAction = {payload: {user: mockUser, additionalData: mockAdditionalData}};
...
describe('on sign up saga', () => {
    ...
    const mockAction = {payload: {email: mockEmail, password: mockPassword, displayName: mockDisplayName}};
